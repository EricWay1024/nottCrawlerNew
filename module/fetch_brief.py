...
def get_schools_from_campus(campus):
    ...
    response = requests.get(
        "https://campus.nottingham.ac.uk/psc/csprd_pub/EMPLOYEE/HRMS/c/"
        "UN_PROG_AND_MOD_EXTRACT.UN_PLN_EXTRT_FL_CP.GBL",
        params=params,
        # cookies=cookies,
        # headers=headers,
    )
    ...
    select_element = module_soup.find(
        "select", id="UN_PLN_EXRT_WRK_DESCRFORMAL"
    )
...
def get_modules_from_school(school_obj):
    ...
    # The URL to request
    url = "https://campus.nottingham.ac.uk/psc/csprd_pub/EMPLOYEE/HRMS/c/"
    "UN_PROG_AND_MOD_EXTRACT.UN_PLN_EXTRT_FL_CP.GBL"
